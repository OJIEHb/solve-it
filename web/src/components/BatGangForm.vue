      ...
      <md-step id="third" md-label="Third Step" md-description="Algorithm details" :md-done.sync="third">
        <div class="md-layout md-alignment-top-center">
          <div class="md-layout-item md-size-60">
            ...
            <md-field>
              <label for="batNumber">Bat number</label>
              <md-input v-model="problem.batNumber" type="number" min="0" id="batNumber" required/>
            </md-field>
            <md-field>
              <label for="alpha">Alpha</label>
              <md-input v-model="problem.alpha" id="alpha" type="number" min="0" step="any" required/>
            </md-field>
            <md-field>
              <label for="gamma">Gamma</label>
              <md-input v-model="problem.gamma" id="gamma" type="number" min="0" step="any" required/>
            </md-field>
            <div class="md-layout md-gutter">
              <div class="md-layout-item">
                <md-field>
                  <label for="maxFrequency">Max frequency</label>
                  <md-input v-model="problem.frequency.max" id="maxFrequency" required/>
                </md-field>
              </div>
              <div class="md-layout-item">
                <md-field>
                  <label for="minFrequency">Min frequency</label>
                  <md-input v-model="problem.frequency.min" id="minFrequency" required/>
                </md-field>
              </div>
            </div>
